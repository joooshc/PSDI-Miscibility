...
if __name__ == '__main__':
    ...
    dataset_scaled, dropped_rows_dict, min_val_dict = feature_scaling(dataset_selected, 'normalize', min_val_dict)
    ...
    dataset_scaled.to_csv("method3_dataset.csv", index=False)
